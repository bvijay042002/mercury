...
function App() {
  return (
    <div className="App">
      ...
      transition={{delay:1.2, duration:.8 }} className="s1">
          <h2>Financal Management</h2>
          <p className="quote">A simpler, smarter basic credit <a className="card">card.</a></p>
          <p className="discription">Your powerful companion on the road to financial success! Explore personal budget management, investment opportunities.</p>
      <div className="followbox">
        <div className="appstore"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path fill="#fff" d="M9.739 6.682c-.609 0-1.55-.692-2.542-.667-1.308.017-2.508.759-3.183 1.934-1.359 2.358-.35 5.841.975 7.758.65.933 1.416 1.983 2.433 1.95.975-.042 1.342-.634 2.525-.634 1.175 0 1.508.634 2.542.609 1.05-.017 1.716-.95 2.358-1.892a8.377 8.377 0 0 0 1.067-2.191c-.025-.009-2.042-.784-2.067-3.117-.017-1.95 1.592-2.884 1.667-2.925-.917-1.342-2.325-1.492-2.817-1.525-1.283-.1-2.358.7-2.958.7zm2.166-1.967c.542-.65.9-1.558.8-2.458-.775.033-1.708.516-2.266 1.167-.5.575-.934 1.5-.817 2.383.858.066 1.742-.442 2.283-1.092z"/></svg> App Store</div>
        <div className="follows"><img className="profpic p1" src="https://framerusercontent.com/images/mjpixPbzIMix5MtxX2IOrVDtKA.png"></img>
        <img className="profpic p2" src="https://framerusercontent.com/images/ChLTRKDcxHYxLN5gf9LJPecpk8.png"></img>
        <img className="profpic p3" src="https://framerusercontent.com/images/8TysGUZ0I12C6YWxZUdhVfEus.png"></img>
        </div>
        <p className="followcount">24K+<br></br><a>Active User</a></p>
      </div>
      </motion.div>
      <motion.div 
      initial={{ y:100,x:-10,scale:0.7, opacity:0}}
      animate={{ y:0,x:0,scale:1, opacity:1}}
      transition={{delay:1.1, duration:1 }} className="s2">
          <div className="gradphone">
          </div>
      </motion.div>
      </div>
      </div>
